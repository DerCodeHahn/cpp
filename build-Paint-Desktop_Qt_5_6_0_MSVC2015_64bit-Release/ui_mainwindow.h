...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/rectangle.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRectangle->setIcon(icon);
        actionCircle = new QAction(MainWindow);
        actionCircle->setObjectName(QStringLiteral("actionCircle"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/icons/circle.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCircle->setIcon(icon1);
        actionDot = new QAction(MainWindow);
        actionDot->setObjectName(QStringLiteral("actionDot"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/dot.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionDot->setIcon(icon2);
        actionLine = new QAction(MainWindow);
        actionLine->setObjectName(QStringLiteral("actionLine"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/icons/line.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        actionStraight_LIne->setObjectName(QStringLiteral("actionStraight_LIne"));
        QIcon icon5;
        ...
        listWidget = new QListWidget(historyTab);
        listWidget->setObjectName(QStringLiteral("listWidget"));
        listWidget->setGeometry(QRect(0, 0, 161, 261));
        ...
        patternBox = new QComboBox(tab);
        patternBox->setObjectName(QStringLiteral("patternBox"));
        patternBox->setGeometry(QRect(20, 100, 111, 22));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_4->setText(QApplication::translate("MainWindow", "Select Pattern Brush", 0));
