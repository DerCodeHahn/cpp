...
QT_MOC_LITERAL(1, 8, 11), // "onMouseMove"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 11), // "onMouseDown"
QT_MOC_LITERAL(4, 33, 9) // "onMouseUp"

    },
    "MyLabel\0onMouseMove\0\0onMouseDown\0"
    "onMouseUp"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onMouseMove((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->onMouseDown((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->onMouseUp((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::onMouseMove)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyLabel::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::onMouseDown)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MyLabel::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::onMouseUp)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MyLabel::onMouseMove(int _t1, int _t2)
{
...
// SIGNAL 1
void MyLabel::onMouseDown(int _t1, int _t2)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 2
void MyLabel::onMouseUp(int _t1, int _t2)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
