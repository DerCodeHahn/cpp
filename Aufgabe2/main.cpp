...
int main()
{
    ...
    EXPECT_CLOSE( fixed_point(std::sin(0.5f)) , sin(fixed_point(0.5f)) , fixed_point(0.01f) );
    EXPECT_CLOSE( fixed_point(std::cos(0.5f)) , cos(fixed_point(0.5f)) , fixed_point(0.01f) );
}
